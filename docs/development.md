...
`.github/workflows/ci.yml` runs `pytest -q` on Ubuntu, Windows, and macOS with Python 3.8 and 3.12 on every push to `main` and every pull request.
...
- Update the docs when you change behavior. See [CONTRIBUTING.md](../CONTRIBUTING.md).
